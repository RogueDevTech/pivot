  ...
  return (
    <section className="flex flex-col gap-[48px] w-full lg:w-[729px]">
      <div className="flex flex-col gap[24px]">
        ...
        <div className="flex flex-col lg:flex-row w-full lg:w-[729px]">
          <div className="flex flex-col gap-[24px] justify-between h-[128px]">
            <Minisize>Work with Exceptional People</Minisize>
            <InnerText>
          ...
          <div className="flex flex-col gap-[24px] justify-between h-[128px]">
            <Minisize>Shape the Future of AI Infrastructure</Minisize>
            <InnerText>
